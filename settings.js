...
//owner v card
global.vcardowner = ['+40746352122'] // owner number
global.ownername = "ঔৣ۝ale۝ঔৣ" // owner name
global.ytname = "" // yt chanel name
global.socialm = "GitHub: prabhasha2006" // github or insta name
global.location = "casa mia" // location
...
global.ownertag = '+40746352122' //your tag number
global.botname = 'ঔৣ۝ale۝ঔৣ𝘉𝘖𝘛' //ur bot name
global.packname = "Bot Sticker" // sticker packname
global.author = "ঔৣ۝ale۝ঔৣ bot" // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = '[ঔৣ۝ale۝ঔৣ bot]' //

//database
global.premium = ['+40746352122'] //ur premium numbers
...
global.mess = {
    success: 'Done ✅',
    admin: 'Solo gli amministratori possono usarlo',
    botAdmin: 'metti il bot come amministratore down',
    owner: 'solo il dio supremo puo utilizzarlo',
    group: 'questa funzione e abilitata soltanto nei gruppi',
    private: 'questa funzione e abilitata soltanto per la chat privata',
    bot: 'This Feature Is Only For Bot😝',
    wait: 'aspetta porco dio',
    error: 'Errore!!! Forse la chiave Api è scaduta',
    endLimit: 'Il tuo limite giornaliero è scaduto, il limite verrà ripristinato ogni 12 ore',
    linkm: 'dove cazzo e il link?',
    nsfw: 'La funzione nsfw non è stata attivata quindi falla attivare dal dio supremo',
    banChat: 'se il bot e stato bannato contatta il creatore',
    badwords: 'chi attiva sta funzione e gay',
    spam: '⚠️ [SPAM] Detected ⚠️\n\nThe emergency security system was activated.\n\nPowered By: *ঔৣ۝ale۝ঔৣ bot*',
    caption: 'Generated by: ◉ *ঔৣ۝ale۝ঔৣ bot*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
